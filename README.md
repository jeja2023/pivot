...
![版本](https://img.shields.io/badge/%E7%89%88%E6%9C%AC-0.1.79-%2310b981)
...
（详细版本变更与历史演进说明请参阅 [CHANGELOG.md](CHANGELOG.md)；本版本公文写作用户数据隔离与服务端文档库升级说明请参阅 [v0.1.79 发布记录](docs/releases/v0.1.79-公文写作用户数据隔离与服务端文档库升级.md)。）
