...
![版本](https://img.shields.io/badge/%E7%89%88%E6%9C%AC-0.1.97-%2310b981)
...
（详细版本变更与历史演进说明请参阅 [CHANGELOG.md](CHANGELOG.md)；本版本检查点恢复与整项重试按钮修复说明请参阅 [v0.1.97 发布记录](docs/releases/v0.1.97-检查点恢复与整项重试按钮修复.md)。）
