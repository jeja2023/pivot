...
![版本](https://img.shields.io/badge/%E7%89%88%E6%9C%AC-0.1.33-%2310b981)
...
（详细版本变更与历史演进说明请参阅 [CHANGELOG.md](CHANGELOG.md)；本版本运行链路、迁移和上线检查请参阅 [v0.1.33 发布记录](docs/releases/v0.1.33-持久化连续Agent发布记录.md)）
