...
![版本](https://img.shields.io/badge/%E7%89%88%E6%9C%AC-0.1.72-%2310b981)
...
（详细版本变更与历史演进说明请参阅 [CHANGELOG.md](CHANGELOG.md)；本版本智能助手四 Tab 架构与视觉规范化说明请参阅 [v0.1.72 发布记录](docs/releases/v0.1.72-智能助手四Tab解耦经验沉淀规范化与全局样式统一.md)。）
