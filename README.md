...
![版本](https://img.shields.io/badge/%E7%89%88%E6%9C%AC-0.1.177-%2310b981)
...
本版本移除 AI PPT 大纲确认页中的格式标记字符：
- 大纲改为普通标题、章节、主题、目标说明和核心要点的层级预览；
- 不显示原始格式符号、JSON 或内部字段，且不再按页码堆叠卡片；
- 生成页面仍使用内部受控大纲对象，保留来源引用、版式和安全校验。

（详细版本变更与历史演进说明请参阅 [CHANGELOG.md](CHANGELOG.md)；本版本说明请参阅 [v0.1.177 发布记录](docs/releases/v0.1.177-演示大纲无格式标记层级预览.md)。）
