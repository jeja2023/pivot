...
![版本](https://img.shields.io/badge/%E7%89%88%E6%9C%AC-0.1.61-%2310b981)
...
（详细版本变更与历史演进说明请参阅 [CHANGELOG.md](CHANGELOG.md)；本版本 Agent 技能、文档交付与桌面连接器安全收口说明请参阅 [v0.1.60 发布记录](docs/releases/v0.1.60-Agent技能与文档交付安全收口.md)。）
