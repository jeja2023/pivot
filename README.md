...
![版本](https://img.shields.io/badge/%E7%89%88%E6%9C%AC-0.1.35-%2310b981)
...
（详细版本变更与历史演进说明请参阅 [CHANGELOG.md](CHANGELOG.md)；本版本安全边界、任务恢复、资源治理和上线检查请参阅 [v0.1.35 发布记录](docs/releases/v0.1.35-安全可靠性与资源治理升级发布记录.md)）
