...
![版本](https://img.shields.io/badge/%E7%89%88%E6%9C%AC-0.0.85-%2310b981)
...
**当前版本**：v0.0.85（智能体任务记录体验精简：任务详情移除时间轴模块，执行步骤标题左对齐；任务列表悬浮补齐完整任务上下文，并取消问号鼠标样式与原生标题提示；累计 v0.0.43–v0.0.85 涵盖基础设施收口、流式 Markdown 节流、RAG 调试可视化、会话 PDF 导出、模型路由 6 策略、工作流可视化编辑器、流式 function calling、实时 SSE、能力库治理、知识库图谱、公告治理、多轮安全加固、工具目录去重、工作流统计闭环、普通对话图表确定性渲染、工作流编排资产化和智能体任务记录体验收口）
