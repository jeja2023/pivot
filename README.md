...
![版本](https://img.shields.io/badge/%E7%89%88%E6%9C%AC-0.1.91-%2310b981)
...
（详细版本变更与历史演进说明请参阅 [CHANGELOG.md](CHANGELOG.md)；本版本 Agent 控制台待办详情链路兼容升级说明请参阅 [v0.1.91 发布记录](docs/releases/v0.1.91-Agent控制台待办详情链路兼容修复.md)。）
