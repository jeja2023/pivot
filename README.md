...
![版本](https://img.shields.io/badge/%E7%89%88%E6%9C%AC-0.1.151-%2310b981)
...
普通会话默认采用知识库与工具库自适应路由；输入“@”后先选择知识库或工具，即可浏览中文分页列表或使用中文/英文名称筛选具体能力。工具执行仍须经过用户授权、白名单、审批和网络策略。

（详细版本变更与历史演进说明请参阅 [CHANGELOG.md](CHANGELOG.md)；本版本说明请参阅 [v0.1.151 发布记录](docs/releases/v0.1.151-筛选行节点筛选条件输入区域重构.md)。）
