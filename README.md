...
![版本](https://img.shields.io/badge/%E7%89%88%E6%9C%AC-0.1.37-%2310b981)
...
- **普通聊天自动连续执行**：Web 和 Electron 的普通聊天会自动创建持久化 Agent；复杂问题可以在页面离开、刷新或切换设备后继续执行，完成答案或错误会回写原会话，并支持停止、批准、拒绝和继续。
