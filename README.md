...
![版本](https://img.shields.io/badge/%E7%89%88%E6%9C%AC-0.1.145-%2310b981)
...
普通会话默认采用知识库与工具库自适应路由；裸输入“@”可同时查看可引用的知识库和当前白名单内的工具。工具执行仍须经过用户授权、白名单、审批和网络策略。

（详细版本变更与历史演进说明请参阅 [CHANGELOG.md](CHANGELOG.md)；本版本说明请参阅 [v0.1.145 发布记录](docs/releases/v0.1.145-聊天@工具显式指定修复.md)。）
