...
![版本](https://img.shields.io/badge/%E7%89%88%E6%9C%AC-0.1.76-%2310b981)
...
（详细版本变更与历史演进说明请参阅 [CHANGELOG.md](CHANGELOG.md)；本版本可用工具弹窗加宽与桌面端连接器限流降噪优化说明请参阅 [v0.1.76 发布记录](docs/releases/v0.1.76-可用工具弹窗加宽与桌面端连接器限流降噪优化.md)。）
