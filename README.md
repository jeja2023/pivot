...
![版本](https://img.shields.io/badge/%E7%89%88%E6%9C%AC-0.1.147-%2310b981)
...
普通会话默认采用知识库与工具库自适应路由；输入“@”后先选择知识库或工具，即可浏览分页列表或使用搜索筛选具体能力。工具执行仍须经过用户授权、白名单、审批和网络策略。

（详细版本变更与历史演进说明请参阅 [CHANGELOG.md](CHANGELOG.md)；本版本说明请参阅 [v0.1.147 发布记录](docs/releases/v0.1.147-聊天@能力分页浏览.md)。）
