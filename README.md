...
![版本](https://img.shields.io/badge/%E7%89%88%E6%9C%AC-0.1.78-%2310b981)
...
（详细版本变更与历史演进说明请参阅 [CHANGELOG.md](CHANGELOG.md)；本版本解除本机浏览器访问与实时联网能力拦截冲突说明请参阅 [v0.1.78 发布记录](docs/releases/v0.1.78-解除本机浏览器访问与实时联网能力拦截冲突.md)。）
