...
![版本](https://img.shields.io/badge/%E7%89%88%E6%9C%AC-0.1.152-%2310b981)
...
工作流编排新增授权隔离缓存、分支汇聚、完整节点重跑、CAS 大输出、子工作流迭代、会话级 Mock、结构化兜底、受控 OpenAPI 接入和跨实例运行配额；普通会话仍默认采用知识库与工具库自适应路由。工具执行继续经过用户授权、白名单、审批和网络策略。

（详细版本变更与历史演进说明请参阅 [CHANGELOG.md](CHANGELOG.md)；本版本说明请参阅 [v0.1.152 发布记录](docs/releases/v0.1.152-工作流编排可靠性安全治理与受控接入升级.md)。）
