...
![版本](https://img.shields.io/badge/%E7%89%88%E6%9C%AC-0.1.123-%2310b981)
...
（详细版本变更与历史演进说明请参阅 [CHANGELOG.md](CHANGELOG.md)；本版本说明请参阅 [v0.1.123 发布记录](docs/releases/v0.1.123-Node20多版本测试绑定自愈与上传中间件异步清理.md)。）
