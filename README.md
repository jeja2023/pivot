...
![版本](https://img.shields.io/badge/%E7%89%88%E6%9C%AC-0.1.80-%2310b981)
...
（详细版本变更与历史演进说明请参阅 [CHANGELOG.md](CHANGELOG.md)；本版本应用中心独立模型选择器与弹窗布局重构说明请参阅 [v0.1.80 发布记录](docs/releases/v0.1.80-应用中心独立模型选择器与弹窗布局重构.md)。）
