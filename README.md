...
![版本](https://img.shields.io/badge/%E7%89%88%E6%9C%AC-0.1.77-%2310b981)
...
（详细版本变更与历史演进说明请参阅 [CHANGELOG.md](CHANGELOG.md)；本版本修复对话能力拦截与视觉输入分支异步缺失异常说明请参阅 [v0.1.77 发布记录](docs/releases/v0.1.77-修复对话能力拦截与视觉输入分支异步缺失异常.md)。）
