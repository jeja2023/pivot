...
![版本](https://img.shields.io/badge/%E7%89%88%E6%9C%AC-0.1.82-%2310b981)
...
（详细版本变更与历史演进说明请参阅 [CHANGELOG.md](CHANGELOG.md)；本版本 Agent 运行时架构分层治理与统一上下文审计契约升级说明请参阅 [v0.1.82 发布记录](docs/releases/v0.1.82-Agent运行时架构分层治理与统一上下文审计契约升级.md)，动态代码沙箱收口与多节点持续调度及检索下沉优化说明请参阅 [v0.1.81 发布记录](docs/releases/v0.1.81-动态代码沙箱收口与多节点持续调度及检索下沉优化.md)。）
