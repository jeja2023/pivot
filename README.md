...
![版本](https://img.shields.io/badge/%E7%89%88%E6%9C%AC-0.1.83-%2310b981)
...
（详细版本变更与历史演进说明请参阅 [CHANGELOG.md](CHANGELOG.md)；本版本模型原生工具调用自适应降级与多节点预检及安全治理升级说明请参阅 [v0.1.83 发布记录](docs/releases/v0.1.83-模型原生工具调用自适应降级与多节点预检及安全治理升级.md)。）
