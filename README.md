...
![版本](https://img.shields.io/badge/%E7%89%88%E6%9C%AC-0.1.73-%2310b981)
...
（详细版本变更与历史演进说明请参阅 [CHANGELOG.md](CHANGELOG.md)；本版本本机文件目录授权文案统一、表格列宽调优与全屏自适应撑满说明请参阅 [v0.1.73 发布记录](docs/releases/v0.1.73-本机文件目录授权文案统一与安全凭据按钮紧凑化.md)。）
