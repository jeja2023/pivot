...
![版本](https://img.shields.io/badge/%E7%89%88%E6%9C%AC-0.1.182-%2310b981)
...
本版本优化个人档案中的工作习惯与工具偏好：
- 工作习惯、常见任务和常用工具从自由文本框升级为标签编辑器，支持 Enter 添加、建议项一键加入、逐项删除和数量提示；
- 常用工具建议只来自当前账号的可用工具目录，显示中文名称与稳定标识，同时兼容已保存的历史工具值；
- 工具偏好仅影响建议和受限上下文，不会扩大账户工具权限或绕过审批；
- 桌面端改为三列紧凑偏好区，让高级设置和保存按钮进入 1920×800 首屏；窄屏自动收敛为单列，避免标签、输入框和建议项重叠。

（详细版本变更与历史演进说明请参阅 [CHANGELOG.md](CHANGELOG.md)；本版本说明请参阅 [v0.1.182 发布记录](docs/releases/v0.1.182-个人档案偏好编辑体验优化.md)。）
