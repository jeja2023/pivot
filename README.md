...
![版本](https://img.shields.io/badge/%E7%89%88%E6%9C%AC-0.1.74-%2310b981)
...
（详细版本变更与历史演进说明请参阅 [CHANGELOG.md](CHANGELOG.md)；本版本个人自主进化、组织受控共享和本机浏览器会话访问说明请参阅 [v0.1.74 发布记录](docs/releases/v0.1.74-个人自主进化与本机浏览器会话访问闭环.md)。）
