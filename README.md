...
![版本](https://img.shields.io/badge/%E7%89%88%E6%9C%AC-0.1.149-%2310b981)
...
（详细版本变更与历史演进说明请参阅 [CHANGELOG.md](CHANGELOG.md)；本版本说明请参阅 [v0.1.149 发布记录](docs/releases/v0.1.149-数据汇总与分组汇总多指标.md)。）
...
- **数据汇总与分组汇总**：工作流可用“数据汇总”对全部数据计算多个统计指标，或用“数据分组汇总”按部门、状态等维度同时计算记录数、总额与平均值；两者均提供字段选择和命名结果配置。
