...
本方案已随 `v0.1.155` 发布。发布范围、主库 PostgreSQL-only 兼容边界、桌面 SQLite 保留范围、升级/回滚条件与完整验证记录见 [v0.1.155 知识库产品化与 PostgreSQL 主库收敛发布记录](docs/releases/v0.1.155-知识库产品化与PostgreSQL主库收敛.md)。
