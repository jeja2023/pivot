...
const modelListFields = "id, user_id, name, url, model_name, is_default, daily_token_limit, allowed_units, (CASE WHEN api_key IS NOT NULL AND length(api_key) > 0 THEN '********' ELSE '' END) AS api_key";
