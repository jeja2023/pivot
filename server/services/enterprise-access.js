...
function getUserEnterpriseContext(userId) {
    ...
    try {
        ...
        return {
            ...
            permissions: listResourcePermissions({ subjectType: 'user', subjectId: safeUserId })
        };
    } catch (err) {
...
function listResourcePermissions(options = {}) {
