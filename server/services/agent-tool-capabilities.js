...
const BUILTIN_TOOL_CAPABILITIES = Object.freeze({
    ...
    'agent.web_search': ['network.web_search'],
    ...
    'workflow.embed_page': ['workflow.control'],
    'workflow.embed_image': ['workflow.control'],
    'workflow.embed_video': ['workflow.control'],
    'workflow.embed_audio': ['workflow.control'],
    'workflow.link_card': ['workflow.control'],
    'workflow.embed_code': ['workflow.control'],
