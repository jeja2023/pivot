...
const PRE_SCHEMA_COLUMNS = [
    ...
    ['messages', 'context_token_count', 'INTEGER'],
    ...
    ['knowledge_chunks', 'char_start', 'INTEGER'],
    ['knowledge_chunks', 'char_end', 'INTEGER'],
    ['agent_runs', 'retry_after', 'DATETIME'],
    ...
    ['refresh_tokens', 'family_id', "TEXT DEFAULT ''"],
    ['refresh_tokens', 'consumed_at', 'DATETIME'],
    ['refresh_tokens', 'device_id', "TEXT DEFAULT ''"],
