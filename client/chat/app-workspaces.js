...
const WORKSPACE_SCRIPT_GROUPS = {
    ...
    agent: [
        ...
        '/chat/agent-run-loaders.js', '/chat/agent-run-dag-focus.js', '/chat/agent-run-invocations.js', '/chat/agent-run-personal-context.js', '/chat/agent-run-status-views.js', '/chat/agent-run-detail.js', '/chat/agent-runtime-packs-console.js', '/chat/agent-personal-experience.js', '/chat/agent-harness.js',
