...
const DAG_NODE_VISUAL = {
    ...
    'workflow.embed_video': { svgIcon: 'globe', theme: 'http', label: '嵌入视频' },
    'workflow.embed_audio': { svgIcon: 'message', theme: 'http', label: '嵌入音频' },
    'workflow.link_card': { svgIcon: 'globe', theme: 'http', label: '链接卡片' },
    'workflow.embed_code': { svgIcon: 'code', theme: 'code', label: '网站嵌入代码' },
    'sessions.recent': { svgIcon: 'message', theme: 'session', label: '最近会话' },
    'knowledge.list': { svgIcon: 'book-open', theme: 'rag', label: '知识库文档列表' },
    'models.list': { svgIcon: 'bot', theme: 'llm', label: '可用模型列表' },
    'artifact.render': { svgIcon: 'file-text', theme: 'report', label: '文档渲染' },
    'artifact.list_renditions': { svgIcon: 'file-text', theme: 'report', label: '渲染结果列表' },
