...
const TOOL_PRIMARY_FIELD_NAMES = {
        ...
        'workflow.embed_video': ['url', 'title', 'height'],
        'workflow.embed_audio': ['url', 'title'],
        'workflow.link_card': ['url', 'title', 'description'],
        'workflow.embed_code': ['url', 'title', 'width', 'height', 'responsive'],
